...
export function createStorageConfig(runtimeEnv: Record<string, string | undefined>) {
  ...
  return { bucket: parsed.S3_BUCKET!, region: parsed.S3_REGION, accessKeyId: parsed.S3_ACCESS_KEY_ID!, secretAccessKey: parsed.S3_SECRET_ACCESS_KEY!, endpoint: parsed.S3_ENDPOINT, rootPrefix: parsed.S3_ROOT_PREFIX };
}
